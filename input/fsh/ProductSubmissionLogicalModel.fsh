...
* differential.element[20].id = "ProductSubmissionDocument.section"
* differential.element[20].path = "ProductSubmissionDocument.section"
* differential.element[20].short = "Document Sections"
* differential.element[20].definition = "A logical grouping of Product Submission information."
...
* differential.element[21].id = "ProductSubmissionDocument.section.identifier"
* differential.element[21].path = "ProductSubmissionDocument.section.identifier"
* differential.element[21].short = "Section Identifier"
* differential.element[21].definition = "An identifier for this section that can be used to reference it in the document."
...
* differential.element[22].id = "ProductSubmissionDocument.section.effectiveTime"
* differential.element[22].path = "ProductSubmissionDocument.section.effectiveTime"
* differential.element[22].short = "Section Effective Time"
* differential.element[22].definition = "The date when this section was authored."
...
* differential.element[23].id = "ProductSubmissionDocument.section.type"
* differential.element[23].path = "ProductSubmissionDocument.section.type"
* differential.element[23].short = "Section Type"
* differential.element[23].definition = "A code that identifies the content conveyed in this section."
...
* differential.element[24].id = "ProductSubmissionDocument.section.title"
* differential.element[24].path = "ProductSubmissionDocument.section.title"
* differential.element[24].short = "Section Title"
* differential.element[24].definition = "A header for the content contained in this section."
...
* differential.element[25].id = "ProductSubmissionDocument.section.text"
* differential.element[25].path = "ProductSubmissionDocument.section.text"
* differential.element[25].short = "Section Text"
* differential.element[25].definition = "The human readable content of this section."
* differential.element[25].min = 0
* differential.element[25].max = "1"
* differential.element[25].mustSupport = true
* differential.element[25].type.code = #xhtml

* differential.element[26].id = "ProductSubmissionDocument.section.highlights"
* differential.element[26].path = "ProductSubmissionDocument.section.highlights"
* differential.element[26].short = "Section Text Highlights"
* differential.element[26].definition = "Content that is not a complete rendering of the information in this section."
...
* differential.element[27].id = "ProductSubmissionDocument.section.image"
* differential.element[27].path = "ProductSubmissionDocument.section.image"
* differential.element[27].short = "Section Images"
* differential.element[27].definition = "References to images that are used in the human readable content of this section."
* differential.element[27].min = 0
* differential.element[27].max = "*"
* differential.element[27].mustSupport = true
* differential.element[27].type.code = #Attachment

* differential.element[28].id = "ProductSubmissionDocument.section.product"
* differential.element[28].path = "ProductSubmissionDocument.section.product"
* differential.element[28].short = "Section Product Information"
...
* differential.element[28].type.code = #MedicinalProduct

* differential.element[29].id = "ProductSubmissionDocument.section.subsection"
* differential.element[29].path = "ProductSubmissionDocument.section.subsection"
* differential.element[29].short = "Section sub-sections"
* differential.element[29].definition = "Sub-groupings of the content contained in a section."
* differential.element[29].min = 0
* differential.element[29].max = "*"
* differential.element[29].mustSupport = true
* differential.element[29].contentReference = "http://hl7.org/fhir/us/spl/StructureDefinition/ProductSubmissionDocumentLogicalModel#ProductSubmissionDocument.section"
