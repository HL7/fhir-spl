...
* section[+]
  ...
  * text.div = """<div xmlns="http://www.w3.org/1999/xhtml"><div style="narrative">
                 ...
                 <img alt="Allopurinol is a structural analogue of the natural purine base, hypoxanthine. It is an inhibitor of xanthine oxidase, the enzyme responsible for the conversion of hypoxanthine to xanthine and of xanthine to uric acid, the end product of purine metabolism in man. Allopurinol is metabolized to the corresponding xanthine analogue, oxipurinol (alloxanthine), which also is an inhibitor of xanthine oxidase." src="allopurinol-usp-2.jpg"/>
                  ...
                  <p>Hyperuricemia may be primary, as in gout, or secondary to diseases such as acute and chronic leukemia, polycythemia vera, multiple myeloma, and psoriasis. It may occur with the use of diuretic agents, during renal dialysis, in the presence of renal damage, during starvation or reducing diets, and in the treatment of neoplastic disease where rapid resolution of tissue masses may occur. Asymptomatic hyperuricemia is not an indication for allopurinol treatment (see <a href="#">INDICATIONS AND USAGE</a>).</p>
...
* section[+]
  ...
  * text.div = """<div xmlns="http://www.w3.org/1999/xhtml"><div style="narrative">
                  ...
                  <p>Allopurinol reduces serum and urinary uric acid concentrations. Its use should be individualized for each patient and requires an understanding of its mode of action and pharmacokinetics (see <a href="#">PRECAUTIONS</a>).</p>
...
* section[+]
  ...
  * section[+]
    ...
    * text.div = """<div xmlns="http://www.w3.org/1999/xhtml"><div style="narrative">
                        ...
                        <p>In patients with pre-existing liver disease, periodic liver function tests are recommended during the early stages of therapy (see <a href="#">WARNINGS</a>).</p>
  ...
  * section[+]
    ...
    * text.status = #additional
    * text.div = """<div xmlns="http://www.w3.org/1999/xhtml"><div style="narrative">
                        <p>Allopurinol is rarely indicated for use in children with the exception of those with hyperuricemia secondary to malignancy or to certain rare inborn errors of purine metabolism (see <a href="#">DOSAGE AND ADMINISTRATION</a>).</p>
    </div></div>"""
* section[+]
  ...
  * section[+]
    ...
    * text.div = """<div xmlns="http://www.w3.org/1999/xhtml"><div style="narrative">
                        ...
                        <p>
                           <span style="font-style: italic">Urogenital:</span> renal failure, uremia (see <a href="#">PRECAUTIONS</a>)</p>
    </div></div>"""
  * section[+]
    * code = http://loinc.org#42229-5 "SPL UNCLASSIFIED SECTION"
